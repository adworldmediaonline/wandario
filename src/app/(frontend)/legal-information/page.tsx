    ...
    <>
      ...
      >
        <section id="overview">
          <h2>Overview</h2>
          <p>
            This legal information page provides important details about the
            legal aspects of using Wandario's services. By accessing and using
            our website, you acknowledge and agree to comply with all applicable
        ...
        <section id="intellectual-property">
          ...
          <p>
            All content published on Wandario, including but not limited to
            text, graphics, logos, images, audio clips, digital downloads, and
            data compilations, is the property of Wandario or its content
            suppliers and is protected by international copyright laws.
          </p>
          <p>
            The compilation of all content on this site is the exclusive
            property of Wandario and is protected by international copyright
            laws. All software used on this site is the property of Wandario or
        ...
        <section id="content-ownership">
          ...
          <p>
            ...
            adapt, publish, translate, and distribute it in any existing or
            future media.
          </p>
          <ul>
            <li>
        ...
        <section id="third-party">
          ...
          <p>
            ...
            advertisements and links to other websites. We are not responsible
            for the content of any linked third-party website. The inclusion of
            any link does not imply endorsement by Wandario of the site.
          </p>
          <p>
        ...
        <section id="changes">
          ...
          <p>
            ...
            time. We will notify users of any material changes through our
            website or via email. Your continued use of our services after such
            modifications constitutes your acceptance of the updated terms.
          </p>
        </section>
      </LegalPageLayout>

      <div className="text-center text-sm text-muted-foreground py-4 border-t mt-8">
        Powered by{' '}
        <Link
