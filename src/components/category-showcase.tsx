...
export default function CategoryShowcase({
  ...
  return (
    <Section className="relative py-24 md:py-32 overflow-hidden" container>
      ...
      >
        {categories.map(category => (
          ...
          >
            <Link href={`/regions/${category.slug}`}>
                ...
                <div className="absolute inset-0 p-6 sm:p-8 flex flex-col justify-end">
                  <div className="transform transition-all duration-500 ease-out group-hover:translate-y-0">
                    ...
                    <div className="overflow-hidden">
                      <div
                        className="text-white mb-4 prose prose-invert prose-sm max-w-none"
                        dangerouslySetInnerHTML={{
                          __html:
                            category.excerpt ||
